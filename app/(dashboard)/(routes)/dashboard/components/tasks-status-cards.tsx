        ...
        <div className="grid gap-4 grid-cols-2 lg:grid-cols-4 w-full">
            <Card className="bg-blue-500 text-white shadow-sm shadow-slate-400">
                ...
                <CardContent className="pb-3">
                    <div className="text-3xl md:text-5xl leading-none font-bold mb-1">{taskCounts(TaskStatus.TODO)}</div>
            ...
            <Card className="bg-yellow-500 text-white shadow-sm shadow-slate-400">
                ...
                <CardContent className="pb-3">
                    <div className="text-3xl md:text-5xl leading-none font-bold mb-1">{taskCounts(TaskStatus.IN_PROGRESS)}</div>
                    <p className="text-xs md:text-sm text-white">
                        On going tasks
                    </p>
                </CardContent>
            ...
            <Card className="bg-green-500 text-white shadow-sm shadow-slate-400">
                ...
                <CardContent className="pb-3">
                    <div className="text-3xl md:text-5xl leading-none font-bold mb-1">{taskCounts(TaskStatus.DONE)}</div>
                    <p className="text-xs md:text-sm text-white">
                        Accomplished tasks
                    </p>
                </CardContent>
            ...
            <Card className="bg-red-500 text-white shadow-sm shadow-slate-400">
                ...
                <CardContent className="pb-3">
                    <div className="text-3xl md:text-5xl leading-none font-bold mb-1">{taskCounts(TaskStatus.CANCELLED)}</div>
                    <p className="text-xs md:text-sm text-white">
                        Cancelled tasks
                    </p>
                </CardContent>
